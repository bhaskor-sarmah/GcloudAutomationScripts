...
#read PROJECT_ID
PROJECT_ID="test-proj-0021"
echo "Enter Project Name:"
#read PROJECT_NAME
PROJECT_NAME="test-proj-0021-name"
echo "Enter Repository Name:"
#read REPO_NAME
REPO_NAME="test-repo-0021"
...
#read BUCKET_NAME
BUCKET_NAME="test-proj-0021-bucket-name"
...
#touch $PROJECT_NAME-$PROJECT_ID-$CURRENT_TIME.txt
#script $PROJECT_NAME-$PROJECT_ID-$CURRENT_TIME.txt

rm -r react-template/src/$RESOURCE_FOLDER 
cp -r $RESOURCE_FOLDER react-template/src/
...
gsutil cp -r ./$RESOURCE_FOLDER gs://$BUCKET_NAME/
...
echo "steps:
      ...
      - name: 'gcr.io/cloud-builders/gsutil'
        args: ['cp','-r','gs://$BUCKET_NAME/$RESOURCE_FOLDER', './src/']
        # Install
...
# 	helper = 
# 	helper = !gcloud auth git-helper --account=$USER_EMAIL --ignore-unknown \$@
# [remote \"origin\"]
...
source.developers.google.com,FALSE,/,TRUE,2147483647,o,git-Bhaskor88.gmail.com=1//0ge9oo7VPinrVCgYIARAAGBASNwF-L9IrEmoQ6bBDQ0Zish1e75jw705wA9yoRwEAsZp0wWu9DubPtZ6H0ZSiL-COw6xCxyHwzro
__END__
eval 'set -o history' 2>/dev/null || unsetopt HIST_IGNORE_SPACE 2>/dev/null
# Done Gcloud Cookie Setting
...
gcloud projects add-iam-policy-binding $PROJECT_ID --member serviceAccount:$PROJECT_NUM@cloudbuild.gserviceaccount.com --role roles/compute.admin
...
gcloud projects add-iam-policy-binding $PROJECT_ID --member serviceAccount:$PROJECT_NUM@cloudbuild.gserviceaccount.com --role roles/iam.serviceAccountTokenCreator
gcloud projects add-iam-policy-binding $PROJECT_ID --member serviceAccount:$PROJECT_NUM@cloudbuild.gserviceaccount.com --role roles/firebase.admin
gcloud projects add-iam-policy-binding $PROJECT_ID --member serviceAccount:$PROJECT_NUM@cloudbuild.gserviceaccount.com --role roles/serviceusage.apiKeysAdmin
...
#gcloud builds submit --config cloudbuild.yaml .
# echo "Completed Initializing Cloud Build !"

echo "Creating Build Trigger...."
gcloud beta builds triggers create cloud-source-repositories  --name="build-trigger" --repo=$REPO_NAME --branch-pattern="^master$"  --build-config="cloudbuild.yaml"
# Disabling the trigger
gcloud beta builds triggers export "build-trigger" --destination=trigger.yaml
...
gcloud iam service-accounts create "cloud-build-trigger" \
    --display-name="Cloud Build Trigger"
gcloud projects add-iam-policy-binding $PROJECT_ID \
    --member="serviceAccount:cloud-build-trigger@$PROJECT_ID.iam.gserviceaccount.com" \
    --role="roles/cloudbuild.builds.editor"
# echo "https://cloudbuild.googleapis.com/v1/projects/$PROJECT_ID/triggers/$TRIGGERID:run"
gcloud services enable cloudscheduler.googleapis.com
gcloud services enable appengine.googleapis.com
gcloud app create --region=us-central
gcloud config set project $PROJECT_ID
gcloud beta scheduler jobs create http my-job --schedule="*/5 * * * *" --uri="https://cloudbuild.googleapis.com/v1/projects/$PROJECT_ID/triggers/$TRIGGERID:run" --http-method="POST" --time-zone="Etc/UTC" \
--message-body=$MESSAGE_BODY --oauth-service-account-email="cloud-build-trigger@$PROJECT_ID.iam.gserviceaccount.com"
